			...
			<form:form modelAttribute="order" class="form-horizontal">
				...
				<div
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							<address>
								<strong>Adres rachunku</strong> <br>
					...
					<div class="row">
							...
							<tbody>
								<c:forEach var="cartItem" items="${order.cart.cartItems}">
									<tr>
										...
										<td class="col-md-1 text-center">PLN ${cartItem.value.product.unitPrice}</td>
										<td class="col-md-1 text-center">PLN ${cartItem.value.totalPrice}</td>
									</tr>
								</c:forEach>
						...
						<button type="submit" class="btn btn-success"
							...
							Potwierdz   <span class="glyphicon glyphicon-chevron-right"></span>
						</button>
