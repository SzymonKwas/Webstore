...
public class ProductValidatorTest {
	...
	public void product_without_UnitPrice_should_be_invalid() {
		...
		Assert.assertTrue(
				bindException.getLocalizedMessage().contains("B³êdna cena produktu. Cena nie mo¿e byæ pusta."));
	}
	...
	public void product_with_existing_productId_invalid() {
		...
		Assert.assertEquals(1, bindException.getErrorCount());
		Assert.assertTrue(
				bindException.getLocalizedMessage().contains("Produkt o wskazanym identyfikatorze ju¿ istnieje."));
	}
